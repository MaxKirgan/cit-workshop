...
Public Class clsVendorDA
    ...
    Public Shared Function GetRecords() As DataSet
        ...
        Try
            ...
            strQuery = "SELECT * FROM tblVendor ORDER BY VendorID"
            ...
            dbDataAdapter.Fill(ds, "tblVendor")
    ...
    Public Shared Function DeleteRecord(ByVal aPrimaryKey As String) As Integer
        ...
        Try
            ...
            'create a SQL string 
            Dim strQuery As String
            strQuery = "DELETE FROM tblVendor WHERE VendorID = ?"
            ...
            dbCommand.Parameters.Add(New OleDbParameter("@VendorID", aPrimaryKey))
    ...
    'Parameter:             object (a Vendor) - clsVendor
    'Return:                Result (number of rows affected) - Integer
    ...
    Public Shared Function AddRecord(ByVal aVendor As clsVendor) As Integer
        ...
        Try
            ...
            'create a SQL string 
            Dim strQuery As String
            strQuery = "INSERT INTO tblVendor (VendorID, VendorName, VendorAddress, VendorPhoneNumber, VendorEmail) VALUES (?, ?, ?, ?,?)"
            ...
            dbCommand.Parameters.AddWithValue("@VendorID", aVendor.VendorID)
            dbCommand.Parameters.AddWithValue("@VendorName", aVendor.VendorName)
            dbCommand.Parameters.AddWithValue("@VendorAddress", aVendor.VendorAddress)
            dbCommand.Parameters.AddWithValue("@VendorPhoneNumber", aVendor.VendorPhoneNumber)
            dbCommand.Parameters.AddWithValue("@VendorEmail", aVendor.VendorEmail)
        ...
        Catch ex As Exception
            ...
            MessageBox.Show("Error occured in Class: clsVendorDA, Method: AddRecord(object), Error: " _
                         & ex.Message)
    ...
    Public Shared Function UpdateRecord(ByVal aVendor As clsVendor) As Integer
        ...
        Try
            ...
            'create a SQL string
            Dim strQuery As String
            strQuery = "UPDATE tblVendor SET VendorName = ?, VendorAddress = ?, VendorPhoneNumber = ?, VendorEmail=?, WHERE VendorID = ?"
        ...
        Catch ex As Exception
            MessageBox.Show("Error occurred in Class: VendorDA.  Method:  UpdateRecords(Object). Error" & ex.Message)
            Return -9
        Finally
            CloseDB(dbConnection)
        End Try
